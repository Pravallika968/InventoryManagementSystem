...
export default class ApiService {
    ...
    static ENCRYPTION_KEY = "pravallika-dev-inventory";
    ...
    static async loginUser(loginData) {
        ...
        // If login successful, save token and role automatically
    ...
    /** Update currently logged-in user's info */
    static async updateCurrentUser(userData) {
        // First, get the current user info to obtain their ID
        const currentUser = await this.getLoggedInUsesInfo();
